        ...
        if opcion == '1':
            ...
            try:
                ...
                if "_f" in id_entrada:
                    ...
                    angulo_roll = float(input("   incremento de roll [0.0]: ") or "0.0")
                ...
                if id_faceta == "todas":
                    ...
                    print(f"   [OK] Orden a la faceta {id_faceta} del {id_panel} de giro roll += {angulo_roll}° y pitch += {angulo_pitch}º enviada.")
